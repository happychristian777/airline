...
<div class="container" style="margin-top: -15px;">
  ...
  <div class="row justify-content-md-center">
   ...
   <form method="post" action="<?php echo base_url();?>Admin/ins_flight">
        <div class="form-group">
          <label for="productName">ORIGIN</label>
          <input name="origin" type="text" class="form-control" id="productName" required >
        </div>
        <div class="form-group">
          <label for="productPrice">DESTINATION</label>
          <input name="dest" type="text" class="form-control" id="productPrice" required>
        </div>
        <div class="form-group">
          <label for="productPrice">ARRIVAL TIME</label>
          <input name="arr_time" type="time" class="form-control" id="productPrice" required>
        </div>
        <div class="form-group">
          <label for="productPrice">DEPARTURE TIME</label>
          <input name="dep_time" type="time" class="form-control" id="productPrice" required>
        </div>
