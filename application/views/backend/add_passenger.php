...
<div class="container" style="margin-top: -15px;">
  ...
  <div class="row justify-content-md-center">
   ...
   <form method="post" action="<?php echo base_url();?>Admin/ins_passenger">
        <div class="form-group">
          <label for="productName">SURNAME</label>
          <input name="surname" type="text" class="form-control" id="productName" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="number" name="phone" class="form-control" id="productPrice" required>
        </div>
