...
<div class="container" style="margin-top: -15px;">
  <h1 class="text-center m-3">Add PASSENGER</h1>
  <div class="row justify-content-md-center">
    <div class="col col-md-8 col-lg-6">
   <form method="post" action="<?php echo base_url();?>Admin/upd_passenger">
   <?php foreach($res as $row) { ?>
        <div class="form-group">
        <input type="hidden" name="id" value="<?php echo $this->input->get('id')?>">
          <label for="productName">SURNAME</label>
          <input name="surname" type="text" value="<?php echo $row->surname; ?>" class="form-control" id="productName" required>
        </div>
        <div class="form-group">
