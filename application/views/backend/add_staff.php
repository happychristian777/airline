...
<div class="container" style="margin-top: -15px;">
  ...
  <div class="row justify-content-md-center">
   ...
   <form method="post" action="<?php echo base_url();?>Admin/ins_staff">
        <div class="form-group">
          <label for="productName">SURNAME</label>
          <input type="text" name="surname"  class="form-control" id="productName" required>
        </div>
        <div class="form-group">
          <label for="productPrice">NAME</label>
          <input name="name" type="text" class="form-control" id="productPrice" required>
        </div>
        <div class="form-group">
          <label for="productPrice">ADDRESS</label>
          <input name="address" type="text" class="form-control" id="productPrice" required>
        </div>
        <div class="form-group">
          <label for="productPrice">PHONE NUMBER</label>
          <input type="text" name="phone" class="form-control" id="productPrice" required>
        </div>
        <div class="form-group">
          <label for="productPrice">SALARY</label>
          <input type="text" name="salary" class="form-control" id="productPrice" placeholder="e.g. $1000" required>
        </div>
